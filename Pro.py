...
class MainWindow(CTk):
   def __init__(self):
       ...
       self.label_theme=CTkOptionMenu(self.menu_frame,
                                      values=['Темна','Світла'],
                                      command=self.chang_theme)
       ...
       self.add_message("Демонстрація відображення зображення:",
                        CTkImage(Image.open('1.png'), size=(300, 300)))

       try:
           self.sock = socket(AF_INET, SOCK_STREAM)
           self.sock.connect(('5.tcp.eu.ngrok.io', 18757))
